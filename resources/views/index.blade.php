...
{{--                                            </div>--}}
            ...
            <div class="brand" style="margin-top: 150px;">
                <div class="col-md-2 brand-grid">
                    <img src="{{asset('assets/frontend/images/sony.jpg')}}" class="img-responsive" alt="">
                </div>
                <div class="col-md-2 brand-grid">
                    <img src="{{asset('assets/frontend/images/apple.jpg')}}" class="img-responsive" alt="" >
                </div>
                <div class="col-md-2 brand-grid">
                    <img src="{{asset('assets/frontend/images/bose.jpg')}}" class="img-responsive" alt="">
                </div>
                <div class="col-md-2 brand-grid">
                    <img src="{{asset('assets/frontend/images/philips.jpg')}}" class="img-responsive" alt="">
                </div>
                <div class="col-md-2 brand-grid">
                    <img src="{{asset('assets/frontend/images/jbl.jpg')}}" class="img-responsive" alt="">
                </div>
                <div class="col-md-2 brand-grid">
                    <img src="{{asset('assets/frontend/images/xiaomi.jpg')}}" class="img-responsive" alt="">
                </div>
                <div class="clearfix"></div>
            </div>
            <!--//brand-->
